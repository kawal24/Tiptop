      ...
      <div className="flex ">
        ...
        <div className="flex     w-[100%] flex-col  mt-36 ml-20 relative right-10">
          <img
            ...
            src=" https://static.wixstatic.com/media/2e2a49_cad6f2e23e5345928667147c8a695e14~mv2.jpg/v1/fill/w_568,h_300,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/2e2a49_cad6f2e23e5345928667147c8a695e14~mv2.jpg"
            alt=""
          />
          ...
          <div className="flex flex-col justify-start  gap-20   mt-6">
            ...
            <p className="text-xs flex   ">5 Products</p>
          </div>
